...
### Research Experience
- **Assistant Professor**, MIT EECS & RLE (2023–Present)
  - PI of $2.2M NSF Quantum Leap Challenge Institute grant
  - Lead 8-person research group working on photonic quantum processors
- **Junior Fellow**, Harvard Society of Fellows (2020–2023)
  - Demonstrated first room-temperature solid-state quantum memory with >1s coherence
  - Developed integrated photon platform for entangled photon generation
...
| Category | Expertise |
|----------|-----------|
| **Quantum Technologies** | Photonic quantum computing, quantum communication, quantum memory, qubit control |
| **Nanophotonics** | Silicon photonics, integrated resonators, quantum emitters, nanofabrication |
| **Programming** | Python (Qiskit, Cirq), C++/CUDA, MATLAB, Verilog, quantum simulation frameworks |
| **Fabrication** | E-beam lithography, thin-film deposition, cleanroom processing, device characterization |

---

### Contact Information
📧 Email: liam.taylor@mit.edu  
🏢 Office: MIT Building 36-527, 77 Massachusetts Ave, Cambridge, MA 02139  
🔬 Lab: Integrated Quantum Photonics Lab, RLE  
🔗 [Google Scholar](https://scholar.google.com/citations?user=LJT12345) | [GitHub](https://github.com/rubysoldiersucceed48) | [LinkedIn](https://linkedin.com/in/liamjtaylor)  
📄 [Download CV](https://rubysoldiersucceed48.github.io/LJT-Homepage/files/LJTaylor_CV.pdf)